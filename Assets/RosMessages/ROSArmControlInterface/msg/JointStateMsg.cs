...
namespace RosMessageTypes.ROSArmControlInterface
{
    ...
    {
        public const string k_RosMessageName = "ROS_Arm_Control_Interface/JointState";
        ...
        public JointStateMsg(float joint_1, float joint_2, float joint_3, float joint_4, float joint_5, float joint_6, float joint_7)
        {
        ...
        private JointStateMsg(MessageDeserializer deserializer)
        {
            ...
            deserializer.Read(out this.joint_7);
        }
